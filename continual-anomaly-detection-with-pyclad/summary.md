Roberto Benitez presented PyClad, a modular library and framework for continual anomaly detection, covering motivation, core abstractions (dataset, scenario, strategy, model, callbacks), a code example, and the roadmap toward vision, time series, and video modalities.
