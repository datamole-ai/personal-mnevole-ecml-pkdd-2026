`<name>` presented TSLE, a Python toolkit unifying change point detection and state detection for time-series segmentation, with 30+ algorithms, new metrics, datasets, and an interactive demo.
