Marek presented an interactive RAG framework for evaluating whether retrieved documents are truly relevant, combining perturbation, similarity, and confidence-drop scoring across multiple retrievers and models.
