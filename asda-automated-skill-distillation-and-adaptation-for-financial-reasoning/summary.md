Victor presented ASPER, a training-free method that teaches LLMs to close financial-reasoning knowledge gaps via an auto-generated agent-skills library, showing up to 17% accuracy uplift on the Farmer benchmark.
