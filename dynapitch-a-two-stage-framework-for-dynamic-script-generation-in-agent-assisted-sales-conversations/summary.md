`<name>` presented a two-stage framework for dynamic sales pitch generation in Intuit's contact center: a ModernBERT classifier for pitch timing/phase, plus a fine-tuned LLaMA 3.1 8B generator.
