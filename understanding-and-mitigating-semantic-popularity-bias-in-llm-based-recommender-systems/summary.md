Shirai presented EST, a method that mitigates semantic popularity bias in LLM-based recommenders by modeling item-to-item semantic influence via a multi-view graph before applying weighted SFT.
